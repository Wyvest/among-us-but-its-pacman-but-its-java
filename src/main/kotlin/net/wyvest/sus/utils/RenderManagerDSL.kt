 ...
 * @see RenderManager
 */
open class VG(val instance: Long)
 ...
 */
fun nanoVG(long: Long, block: VG.() -> Unit) = block.invoke(VG(long))


fun Long.drawRect(x: Number, y: Number, width: Number, height: Number, color: Int) =  RenderManager.drawRect(this, x.toFloat(), y.toFloat(), width.toFloat(), height.toFloat(), color)
